    ...
    <div>
      <main>
        <div class="About-Wrapper">
          ...
          <p>
            אצלנו, שוטפים את רכבך בצורה הכי טובה שאפשר, באמצעות שיטות שפותחו
            באמריקה וללא שריטות כלל. אנחנו מבטיחים שרכבך ייצא פשוט נוצץ אחרי
            ביקור אצלנו.
          </p>
          <Image
            src={sabih}
          ...
          <p>
            בנוסף, רק אצלנו, בזמן שהרכב שלך בשטיפה, אתה מוזמן לאכול את הסביח
            המצויין שלנו בתסביח - הסביח שיתסבך אותך לגמרי.
          </p>
        </div>
      </main>
    </div>
      ...
      <main>
        <div className="Map-Box">
          <div className="Map-GoogleMap">
            <iframe
              title="מפה"
              width={window.innerWidth <= 768 ? 250 : 650}
          ...
          <div className="Map-Addr">
            ...
            <p>ליד אוויס</p>
            <h2>איך מגיעים?</h2>
            <p>נוסעים על כביש 40, מגיעים לצומת ביל״ו, ועוצרים ליד בילו סנטר</p>
          </div>
        </div>
      </main>
    </div>
